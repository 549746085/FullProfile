...
RTE/Board_Support/adi_ble_noos.o: C:/Analog\ Devices/CrossCore\ Embedded\ Studio\ 2.8.0/ARM/packs/AnalogDevices/EVAL-ADICUP3029_BSP/1.0.0/Source/ble/framework/noos/adi_ble_noos.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore GCC ARM Embedded C Compiler'
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -DCORE0 -D_DEBUG -D__ADUCM302x__ -DEVAL_ADICUP3029 -D_RTE_ -D__ADUCM3029__ -D__SILICON_REVISION__=0x100 @includes-f3c16c2f1835f0fe1601a2bf6aadaf10.txt -Wall -c -mcpu=cortex-m3 -mthumb -MMD -MP -MF"RTE/Board_Support/adi_ble_noos.d" -MT"RTE/Board_Support/adi_ble_noos.d" -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
RTE/Board_Support/adi_ble_radio.o: C:/Analog\ Devices/CrossCore\ Embedded\ Studio\ 2.8.0/ARM/packs/AnalogDevices/EVAL-ADICUP3029_BSP/1.0.0/Source/ble/radio/adi_ble_radio.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore GCC ARM Embedded C Compiler'
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -DCORE0 -D_DEBUG -D__ADUCM302x__ -DEVAL_ADICUP3029 -D_RTE_ -D__ADUCM3029__ -D__SILICON_REVISION__=0x100 @includes-f3c16c2f1835f0fe1601a2bf6aadaf10.txt -Wall -c -mcpu=cortex-m3 -mthumb -MMD -MP -MF"RTE/Board_Support/adi_ble_radio.d" -MT"RTE/Board_Support/adi_ble_radio.d" -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
RTE/Board_Support/adi_ble_transport.o: C:/Analog\ Devices/CrossCore\ Embedded\ Studio\ 2.8.0/ARM/packs/AnalogDevices/EVAL-ADICUP3029_BSP/1.0.0/Source/ble/transport/adi_ble_transport.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore GCC ARM Embedded C Compiler'
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -DCORE0 -D_DEBUG -D__ADUCM302x__ -DEVAL_ADICUP3029 -D_RTE_ -D__ADUCM3029__ -D__SILICON_REVISION__=0x100 @includes-f3c16c2f1835f0fe1601a2bf6aadaf10.txt -Wall -c -mcpu=cortex-m3 -mthumb -MMD -MP -MF"RTE/Board_Support/adi_ble_transport.d" -MT"RTE/Board_Support/adi_ble_transport.d" -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
RTE/Board_Support/adi_timestamp.o: C:/Analog\ Devices/CrossCore\ Embedded\ Studio\ 2.8.0/ARM/packs/AnalogDevices/EVAL-ADICUP3029_BSP/1.0.0/Source/common/adi_timestamp.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore GCC ARM Embedded C Compiler'
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -DCORE0 -D_DEBUG -D__ADUCM302x__ -DEVAL_ADICUP3029 -D_RTE_ -D__ADUCM3029__ -D__SILICON_REVISION__=0x100 @includes-f3c16c2f1835f0fe1601a2bf6aadaf10.txt -Wall -c -mcpu=cortex-m3 -mthumb -MMD -MP -MF"RTE/Board_Support/adi_timestamp.d" -MT"RTE/Board_Support/adi_timestamp.d" -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
